...
import { FaUser, FaCouch, FaPhone, FaEnvelope, FaCalendar, FaClock, FaEdit, FaTrash, FaClipboard } from 'react-icons/fa';
                                ...
                                <div className="bg-amber-50 p-4 rounded-lg">
                                    ...
                                    <div className="space-y-2">
                                        <div>
                                            ...
                                            <span className="ml-2">{selectedRequest.orderedBy?.fullname}</span>
                                        </div>
                                        <div>
